...
function genCode(currentTimeStamp = new Date().getTime()) {
    var code = "o"; //Math.random().toString(36).substring(2, 5) + Math.random().toString(36).substring(2, 5);
    var failed = false;
    var attempts = 0;
    while (doesCodeExistInCache(code, currentTimeStamp)) {
        ...
        Sleep(100);
        code = "o"; //Math.random().toString(36).substring(2, 5) + Math.random().toString(36).substring(2, 5);
    }
    if (failed) {
