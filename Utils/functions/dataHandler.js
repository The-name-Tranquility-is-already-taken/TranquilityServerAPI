// Have number gaps so its easier to reorder them without changing all the values
exports.dataFormats = {
    ALL: 1,
    ADMIN: 3,
    USER: 5,
 ...
 * @param {number} PermissionLevel Permission level of the user that is seeing this data
